...
env = SimpleGridV1(height=width, width=height, seed=0, device=device, render_mode='human')
...
env_0 = SimpleGridV1(height=width, width=height, seed=0, device=device, render_mode='human')
...
plt.scatter(wind_probs, evals, alpha=0.5, s=3)
plt.show()
...
next_states_a, rewards_a = env.get_all_transitions(render=True)
