...
class BatchREINFORCEFTW:
    ...
    def train_step(self, N,
        ...
        if sample_mode == 'trajectories':
            ...
            paths = trajectory_sampler.sample_paths_parallel(N, policy_copy, T, env_name, self.seed, num_cpu)
        elif sample_mode == 'samples':
            paths = batch_sampler.sample_paths(N, self.policy, T, env_name=env_name, pegasus_seed=self.seed, num_cpu=num_cpu)
