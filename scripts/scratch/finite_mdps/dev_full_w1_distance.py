...
env_a = SimpleGridV1(height=25, width=25, seed=1, device=device, render_mode='human')
env_b = SimpleGridV1(height=25, width=25, seed=1, device=device, render_mode='human')
