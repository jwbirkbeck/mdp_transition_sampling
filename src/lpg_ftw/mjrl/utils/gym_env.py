...
class GymEnv(object):
    def __init__(self, env_name):
        ...
        self._action_dim = self.env.unwrapped.action_space.shape[0]
        self._observation_dim = self.env.unwrapped.observation_space.shape[0]
        try:
            self._num_agents = self.env.unwrapped.num_agents
